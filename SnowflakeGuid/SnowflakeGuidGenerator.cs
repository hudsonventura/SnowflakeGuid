...
/// </remarks>
internal class SnowflakeGuidGenerator : ISnowflakeIDGenerator
{
    private readonly ulong MACHINE_ID;

    private static ulong _Sequence;
    private static ulong Sequence { get => _Sequence; set => _Sequence = value % SnowflakeGuid.MaxSequence; }
    ...
    {
        if (machineId >= SnowflakeGuid.MaxMachineId)
        {
            throw new ArgumentOutOfRangeException(nameof(machineId), $"{nameof(machineId)} must be less than {SnowflakeGuid.MaxMachineId}. Got: {machineId}.");
        }
    ...
    /// </exception>
    public SnowflakeGuid GetSnowflake()
    {
        lock (lockObject)
        {
            ...
            SnowflakeGuid snowflake = new(ConfiguredEpoch)
            {
    ...
    /// <summary>
    /// Gets the next SnowflakeGuid ID as a number.
    /// </summary>
    /// <returns>A <see cref="ulong"/> representing the next SnowflakeGuid ID.</returns>
    /// <remarks>
    /// <para>This method generates a new SnowflakeGuid ID and returns it as a numeric value.</para>
    ...
    /// <summary>
    /// Static method to get the next SnowflakeGuid ID for a given machine ID.
    /// </summary>
    ...
    /// </remarks>
    [CLSCompliant(false)]
    public static SnowflakeGuid GetSnowflake(ulong machineId) => new SnowflakeGuidGenerator(machineId).GetSnowflake();

    /// <summary>
    /// Static method to get the next SnowflakeGuid ID for a given machine ID using a custom epoch date.
    /// </summary>
    /// <param name="machineId">The machine ID as a <see cref="ulong"/>.</param>
    /// <param name="customEpoch">The custom epoch date as a <see cref="DateTime"/>.</param>
    /// <returns>A <see cref="Snowflake"/> object containing the generated ID.</returns>
    [CLSCompliant(false)]
    public static SnowflakeGuid GetSnowflake(ulong machineId, DateTime customEpoch) =>
    ...
    /// <returns>A <see cref="Snowflake"/> object containing the generated ID.</returns>
    public static SnowflakeGuid GetSnowflake(int machineId = 0) => GetSnowflake((ulong)machineId);
    ...
    /// <param name="customEpoch">The custom epoch date as a <see cref="DateTime"/>.</param>
    /// <returns>A <see cref="Snowflake"/> object containing the generated ID.</returns>
    public static SnowflakeGuid GetSnowflake(int machineId, DateTime customEpoch) => GetSnowflake((ulong)machineId, customEpoch);

    /// <summary>
    /// Static method to get the next SnowflakeGuid ID as a number for a given machine ID.
    /// </summary>
    /// <param name="machineId">The machine ID as a <see cref="ulong"/>.</param>
    /// <returns>A <see cref="ulong"/> representing the next SnowflakeGuid ID.</returns>
    /// <remarks>
    ...
    /// <summary>
    /// Static method to get the next SnowflakeGuid ID as a number for a given machine ID using a custom epoch date.
    /// </summary>
    /// <param name="machineId">The machine ID as a <see cref="ulong"/>.</param>
    /// <param name="customEpoch">The custom epoch date as a <see cref="DateTime"/>.</param>
    /// <returns>A <see cref="ulong"/> representing the next SnowflakeGuid ID.</returns>
    ...
    /// <summary>
    /// Gets the next SnowflakeGuid ID as a string for a given machine ID.
    /// </summary>
    /// <param name="machineId">The machine ID as a <see cref="ulong"/>.</param>
    /// <returns>A <see cref="string"/> representing the next SnowflakeGuid ID.</returns>
    [CLSCompliant(false)]
    ...
    /// <summary>
    /// Gets the next SnowflakeGuid ID as a string for a given machine ID using a custom epoch date.
    /// </summary>
    /// <param name="machineId">The machine ID as a <see cref="ulong"/>.</param>
    /// <param name="customEpoch">The custom epoch date as a <see cref="DateTime"/>.</param>
    /// <returns>A <see cref="string"/> representing the next SnowflakeGuid ID.</returns>

...
namespace SnowflakeID.Exceptions
{
    ...
    public class SnowflakesUsingDifferentEpochsException : ArgumentException
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SnowflakesUsingDifferentEpochsException"/> class.
        /// </summary>
        public SnowflakesUsingDifferentEpochsException() : this(DefaultMessage) { }

        /// <summary>
        /// Initializes a new instance of the <see cref="SnowflakesUsingDifferentEpochsException"/> class with a specified error message.
        /// </summary>
        /// <param name="message">The error message that explains the reason for the exception.</param>
        public SnowflakesUsingDifferentEpochsException(string message) : base(message) { }

        /// <summary>
        /// Initializes a new instance of the <see cref="SnowflakesUsingDifferentEpochsException"/> class with a specified error message and a reference to the inner exception that is the cause of this exception.
        /// </summary>
        /// <param name="message">The error message that explains the reason for the exception.</param>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SnowflakesUsingDifferentEpochsException"/> class with a specified error message and the name of the parameter that causes this exception.
        /// </summary>
        /// <param name="message">The error message that explains the reason for the exception.</param>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SnowflakesUsingDifferentEpochsException"/> class with a specified error message, the parameter name, and a reference to the inner exception that is the cause of this exception.
        /// </summary>
        /// <param name="message">The error message that explains the reason for the exception.</param>
        /// <param name="paramName">The name of the parameter that caused the current exception.</param>
        /// <param name="innerException">The exception that is the cause of the current exception.</param>
...
#if (NET20_OR_GREATER || NETSTANDARD2_0_OR_GREATER || NET5_0_OR_GREATER) && !NET8_0_OR_GREATER
        /// <summary>
        /// Initializes a new instance of the <see cref="SnowflakesUsingDifferentEpochsException"/> class with serialized data.
        /// </summary>
